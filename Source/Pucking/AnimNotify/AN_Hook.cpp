...
#include "AnimNotify/AN_Hook.h"

#include "ActorComponent/HookComponent.h"
#include "GameFramework/SpringArmComponent.h"

void UAN_Hook::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	UHookComponent* HookComp = OwnerActor->FindComponentByClass<UHookComponent>();
	...
	if(HookComp)
	{
		if (USpringArmComponent* SpringArmComponent = MeshComp->GetOwner()->FindComponentByClass<USpringArmComponent>())
		{
			...
			HookComp->ShootHook(OriginStartLoc, ForwardVector);
		}
	}
}
